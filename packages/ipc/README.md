...
This package provides IPC functionality for Coder, allowing external applications to communicate with the extension through a socket-based interface.
...
- `configuration`: Coder settings object
...
```typescript
import { IpcClient } from "@coder/ipc"
...
- Unix/Linux/macOS: `/tmp/coder-{id}.sock`
- Windows: `\\.\pipe\coder-{id}`
