// pnpm --filter @coder/core test src/custom-tools/__tests__/custom-tool-registry.spec.ts

import path from "path"
import { fileURLToPath } from "url"

import { type CustomToolDefinition, parametersSchema as z } from "@coder/types"
