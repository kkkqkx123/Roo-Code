// pnpm --filter @coder/core test src/custom-tools/__tests__/format-native.spec.ts

import { type SerializedCustomToolDefinition, parametersSchema as z, defineCustomTool } from "@coder/types"
