...
export const globalSettingsSchema = z.object({
	...
	ignoreMode: z.enum(["gitignore", "rooignore", "both"]).optional(),
	...
	/**
	 * Whether Skill functionality is enabled globally.
	 * When false, all skills are disabled and no skill content is included in system prompts.
	 * @default true
	 */
	 ...
	 * Used by the worktree feature to open the Coder sidebar in a new window.
	 */
	...
	/**
	 * List of skill names to globally disable.
	 * Skills in this list will be excluded from prompt generation.
...
export const coderSettingsSchema = providerSettingsSchema.merge(globalSettingsSchema)

export type CoderSettings = GlobalSettings & ProviderSettings
...
export type SecretState = {
	[K in (typeof SECRET_STATE_KEYS)[number]]?: string
} & {
...
export const EVALS_SETTINGS: CoderSettings = {
