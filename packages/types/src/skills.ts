...
export interface SkillMetadata {
	...
	modeSlugs?: string[]
	/**
	 * Whether the skill is enabled for inclusion in system prompts.
	 * - undefined or true: skill is enabled (default)
	 * - false: skill is disabled and won't appear in system prompts
	 */
