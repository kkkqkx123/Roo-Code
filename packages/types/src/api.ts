...
export interface CoderAPI extends EventEmitter<CoderAPIEvents> {
	/**
	 ...
	 * @returns The current configuration.
	 */
	getConfiguration(): CoderSettings
	/**
	 * Sets the configuration for the current task.
	 * @param values An object containing key-value pairs to set.
	 */
	setConfiguration(values: CoderSettings): Promise<void>
	/**
...
export interface CoderIpcServer extends EventEmitter<IpcServerEvents> {
	listen(): void
