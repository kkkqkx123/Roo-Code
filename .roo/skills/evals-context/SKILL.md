---
name: evals-context
description: Provides context about the Coder evals system structure in this monorepo. Use when tasks mention "evals", "evaluation", "eval runs", "eval exercises", or working with the evals infrastructure. Helps distinguish between the evals execution system (packages/evals, apps/web-evals) and the public website evals display page (apps/web-coder/src/app/evals).
---
...
- Modifying the public evals display page on coder.com
...
| **Website Evals Page**      | `apps/web-coder/src/app/evals/`                             | Public coder.com page displaying eval results                |
| **External Exercises Repo** | [coder-Evals](https://github.com/CoderInc/coder-Evals) | Actual coding exercises (NOT in this monorepo)                 |
...
### `apps/web-coder/src/app/evals/` - Public Website Evals Page

```
apps/web-coder/src/app/evals/
...
This page **displays** eval results on the public coder.com website. It imports types from `@coder/evals` but does NOT run evals.
...
- **Runner**: Isolated Docker container with VS Code + Coder extension + language runtimes
...
1. Add exercise to [coder-Evals](https://github.com/CoderInc/coder-Evals) repo (external)
...
Edit files in [`apps/web-coder/src/app/evals/`](apps/web-coder/src/app/evals/):

- [`evals.tsx`](apps/web-coder/src/app/evals/evals.tsx) - Display component
- [`plot.tsx`](apps/web-coder/src/app/evals/plot.tsx) - Charts
...
## Key Types/Exports from `@coder/evals`
...
- Used by both `apps/web-evals` and `apps/web-coder`
