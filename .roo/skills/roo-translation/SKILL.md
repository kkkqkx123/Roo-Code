...
description: Provides comprehensive guidelines for translating and localizing Coder extension strings. Use when tasks involve i18n, translation, localization, adding new languages, or updating existing translation files. This skill covers both core extension (src/i18n/locales/) and WebView UI (webview-ui/src/i18n/locales/) localization.
---

# Coder Translation Skill

## When to Use This Skill

Use this skill when the task involves:

- Adding new translatable strings to the Coder extension
