...
export type RouterName = never

export const isRouterName = (_value: string): _value is RouterName => false

export function toRouterName(_value?: string): RouterName {
	throw new Error(`Invalid router name: ${_value}`)
}
...
// No dynamic providers available
export type GetModelsOptions = never
