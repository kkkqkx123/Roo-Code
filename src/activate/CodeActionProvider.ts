...
import { CodeActionName, CodeActionId } from "@coder/types"
...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with Coder",
	FIX: "Fix with Coder",
	IMPROVE: "Improve with Coder",
	ADD_TO_CONTEXT: "Add to Coder",
	NEW_TASK: "New Coder Task",
} as const
