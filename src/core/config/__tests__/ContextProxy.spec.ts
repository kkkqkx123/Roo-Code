...
import { GLOBAL_STATE_KEYS, SECRET_STATE_KEYS, GLOBAL_SECRET_KEYS } from "@coder/types"
...
describe("ContextProxy", () => {
	...
	describe("getProviderSettings", () => {
		...
		it("should preserve valid apiProvider and provider fields", async () => {
			await proxy.setValues({
				apiProvider: "openai",
				apiModelId: "gpt-4",
			...
			expect(settings.openAiBaseUrl).toBe("https://api.openai.example/v1")
