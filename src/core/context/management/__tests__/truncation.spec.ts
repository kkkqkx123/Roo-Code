...
describe("Non-Destructive Sliding Window Truncation", () => {
	...
	beforeEach(() => {
		...
		messages = [
			{ role: "user" as const, content: "Initial task", ts: 1000 },
			{ role: "assistant" as const, content: "Response 1", ts: 1100 },
			{ role: "user" as const, content: "Message 2", ts: 1200 },
			{ role: "assistant" as const, content: "Response 2", ts: 1300 },
			{ role: "user" as const, content: "Message 3", ts: 1400 },
			{ role: "assistant" as const, content: "Response 3", ts: 1500 },
			{ role: "user" as const, content: "Message 4", ts: 1600 },
			{ role: "assistant" as const, content: "Response 4", ts: 1700 },
			{ role: "user" as const, content: "Message 5", ts: 1800 },
			{ role: "assistant" as const, content: "Response 5", ts: 1900 },
			{ role: "user" as const, content: "Message 6", ts: 2000 },
		]
	})
	...
	describe("getEffectiveApiHistory()", () => {
		...
		it("should handle both condenseParent and truncationParent filtering", () => {
			...
			const messagesWithCondense: ApiMessage[] = [
				{ role: "user" as const, content: "Initial", ts: 1000 },
				{ role: "assistant" as const, content: "Msg 1", ts: 1100, condenseParent: "condense-1" },
				{ role: "user" as const, content: "Msg 2", ts: 1200, condenseParent: "condense-1" },
				{
				...
				{ role: "user" as const, content: "Msg 3", ts: 1300 },
				{ role: "assistant" as const, content: "Msg 4", ts: 1400 },
			]
	...
	describe("cleanupAfterTruncation()", () => {
		...
		it("should handle both condenseParent and truncationParent cleanup", () => {
			const messagesWithBoth: ApiMessage[] = [
				{ role: "user" as const, content: "Initial", ts: 1000 },
				{ role: "assistant" as const, content: "Msg 1", ts: 1100, condenseParent: "orphan-condense" },
				{ role: "user" as const, content: "Msg 2", ts: 1200, truncationParent: "orphan-truncation" },
				{ role: "assistant" as const, content: "Msg 3", ts: 1300 },
			]
		...
		it("should preserve valid parent references", () => {
			const messagesWithValidParents: ApiMessage[] = [
				{ role: "user" as const, content: "Initial", ts: 1000 },
				{ role: "assistant" as const, content: "Msg 1", ts: 1100, condenseParent: "valid-condense" },
				{
					role: "assistant" as const,
					content: "Summary",
					ts: 1150,
				...
				{ role: "user" as const, content: "Msg 2", ts: 1200, truncationParent: "valid-truncation" },
				{
					role: "assistant" as const,
	...
	describe("Edge cases", () => {
		...
		it("should handle empty condenseParent and truncationParent gracefully", () => {
			const messagesWithoutTags: ApiMessage[] = [
				{ role: "user" as const, content: "Message 1", ts: 1000 },
				{ role: "assistant" as const, content: "Response 1", ts: 1100 },
			]
