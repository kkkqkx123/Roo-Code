import { afterEach, beforeEach, describe, expect, it, vi, vitest, type MockedClass, type MockedFunction } from "vitest"
	...
	describe("createEmbeddings", () => {
		...
		describe("Azure OpenAI compatibility", () => {
			...
			const createMockResponse = (data: any, status = 200, ok = true) => ({
				...
				text: vi.fn().mockResolvedValue(status === 200 ? "" : "Error message"),
			})
