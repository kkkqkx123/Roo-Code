...
import type { Worktree, WorktreeListResponse, WorktreeIncludeStatus } from "@coder/types"
				...
				{isLoading ? (
					...
					<div className="flex flex-col gap-1">
						{worktrees.map((worktree) => (
							<div
								key={worktree.path}
								className={`p-2.5 px-3.5 rounded-xl hover:bg-vscode-list-hoverBackground border border-transparent ${worktree.isCurrent
