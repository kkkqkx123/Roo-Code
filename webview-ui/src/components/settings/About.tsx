...
import { Package } from "@coder/package"
				...
				<div className="flex flex-col gap-3">
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="https://github.com/CoderInc/coder/issues/new?template=bug_report.yml">
					...
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="https://github.com/CoderInc/coder/issues/new?template=feature_request.yml">
					...
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="https://github.com/CoderInc/coder/security/policy">
					...
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="mailto:support@coder.com">support@coder.com</VSCodeLink>
						</span>
					</div>
					<div className="flex items-start gap-2">
						...
						<span>
							<Trans
								...
								components={{
									redditLink: <VSCodeLink href="https://reddit.com/r/Coder" />,
									discordLink: <VSCodeLink href="https://discord.gg/coder" />,
								}}
							/>
						</span>
					</div>
