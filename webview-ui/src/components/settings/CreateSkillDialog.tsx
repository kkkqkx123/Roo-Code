...
import { validateSkillName as validateSkillNameShared, SkillNameValidationError } from "@coder/types"
...
/**
 * Validate skill name using shared validation from @coder/types.
