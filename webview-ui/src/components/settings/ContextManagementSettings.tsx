...
import { supportPrompt } from "@coder/support-prompt"
	...
	return (
		<div className={cn("flex flex-col gap-2", className)} {...props}>
			...
			<Section>
				...
				<SearchableSetting
					settingId="context-ignore-mode"
					section="contextManagement"
					label={t("settings:contextManagement.ignoreMode.label")}>
					<Select
						value={ignoreMode || "both"}
						onValueChange={(value) => setCachedStateField("ignoreMode", value as "gitignore" | "rooignore" | "both")}
						data-testid="ignore-mode-select">
						<SelectTrigger>
							<SelectValue />
						</SelectTrigger>
						<SelectContent>
							<SelectItem value="gitignore">
								{t("settings:contextManagement.ignoreMode.gitignore")}
							</SelectItem>
							<SelectItem value="rooignore">
								{t("settings:contextManagement.ignoreMode.rooignore")}
							</SelectItem>
							<SelectItem value="both">
								{t("settings:contextManagement.ignoreMode.both")}
							</SelectItem>
						</SelectContent>
					</Select>
					<div className="text-vscode-descriptionForeground text-sm mt-1 mb-3">
						{t("settings:contextManagement.ignoreMode.description")}
					</div>
				</SearchableSetting>
