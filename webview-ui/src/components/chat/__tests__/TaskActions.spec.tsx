import type { HistoryItem } from "@coder/types"
	...
	useTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				...
				"chat:task.connectToCloudDescription": "Sign in to Coder Cloud to share tasks",
				...
				"cloud:cloudBenefitsTitle": "Connect to Coder Cloud",
