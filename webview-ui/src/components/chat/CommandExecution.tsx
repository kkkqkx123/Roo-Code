...
import { type ExtensionMessage, type CommandExecutionStatus, commandExecutionStatusSchema } from "@coder/types"

import { safeJsonParse, COMMAND_OUTPUT_STRING } from "@coder/core/browser"
import { parseCommand } from "@coder/parse-command"
