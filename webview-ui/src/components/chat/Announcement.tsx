					...
					<div className="mt-4 text-sm text-center text-vscode-descriptionForeground">
						<div className="flex items-center justify-center gap-4">
							...
							<SocialLink
								...
								label="Reddit"
								href="https://www.reddit.com/r/Coder/"
							/>
						</div>
					</div>
...
const GitHubLink = ({ children }: { children?: ReactNode }) => (
	<VSCodeLink
		href="https://github.com/CoderInc/coder"
		onClick={(e) => {
			e.preventDefault()
			vscode.postMessage({ type: "openExternal", url: "https://github.com/CoderInc/coder" })
		}}>
		{children}
	</VSCodeLink>
)
...
const CareersLink = ({ children }: { children?: ReactNode }) => (
	<VSCodeLink
		href="https://careers.coder.com"
		onClick={(e) => {
			e.preventDefault()
			vscode.postMessage({ type: "openExternal", url: "https://careers.coder.com" })
		}}>
		{children}
	</VSCodeLink>
)
