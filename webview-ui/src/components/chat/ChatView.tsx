...
import type { ClineAsk, ClineSayTool, ClineMessage, ExtensionMessage, AudioType } from "@coder/types"
...
const ChatViewComponent: React.ForwardRefRenderFunction<ChatViewRef, ChatViewProps> = (
	...
	const isProfileDisabled = useMemo(
		() => !!apiConfiguration && !ProfileValidator.isProfileAllowed(apiConfiguration),
		[apiConfiguration],
	)
