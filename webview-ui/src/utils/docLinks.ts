/**
 * Utility for building Coder documentation links with UTM telemetry.
 *
...
export function buildDocLink(path: string, campaign: string): string {
	...
	const baseUrl = `https://docs.coder.com/${basePath}?utm_source=extension&utm_medium=ide&utm_campaign=${encodeURIComponent(campaign)}`
